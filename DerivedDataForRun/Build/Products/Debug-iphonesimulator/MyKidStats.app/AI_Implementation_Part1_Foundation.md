...
**Verification:**
- [x] Colors compile
- [x] Preview shows different colors in light/dark mode
- [x] No custom hex values used
**Verification:**
- [x] Colors compile
- [x] Preview shows different colors in light/dark mode
- [x] No custom hex values used
...
**Verification:**
- [x] Fonts compile
- [x] Preview shows different text sizes
- [x] Works with Dynamic Type (test in Settings → Accessibility)
...
**Verification:**
- [x] File compiles
- [x] Values can be used: `.padding(.spacingL)`
- [x] Button sizes match specification
